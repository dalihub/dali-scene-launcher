...
//    mShadowCamera.SetTargetPosition(Vector3::ZERO);
    ...
    Actor shadowDebugActor = CreateTexturedQuadActor(plainOldShader, mShadowRenderTargetTexture, true);
#endif
  ...
  void InitActors()
  {
    ...
    mShadowCamera.SetPosition( mCameraPosition );
    ...
    mShadowCamera.SetOrientation( camOrientation );
    ...
    mShadowModel.SetShaderUniform("uCubeMatrix" , matCube );
