...
int ConnectKeyEvent( lua_State* state )
{
  ...
  stage.KeyEventSignal().Connect( static_cast<Scene3dLauncher*>( sceneLauncherPtr ), &Scene3dLauncher::OnKeyEvent );
...
int QuitApplication( lua_State* state )
{
  ...
  static_cast<Scene3dLauncher*>( sceneLauncherPtr )->ApplicationQuit();
