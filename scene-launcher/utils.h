...
///@brief Creates a new Renderer with all conceivable properties of the
/// given Renderer @a r. A new TextureSet will be created, but all Texture,
/// Shader and Geometry references are shared between @a r and the new instance.
Dali::Renderer CloneRenderer(Dali::Renderer r);

///@brief Create a new actor with all conceivable properties (excluding
/// actual Dali::Property-s at the moment) of the given actor @a a.
