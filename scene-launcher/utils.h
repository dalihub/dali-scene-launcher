...
private:
  struct StreamBuffer : std::basic_streambuf<char>
  {
  ...
  static char sMessageBuffer[512];
...
{
  a.SetAnchorPoint(Dali::AnchorPoint::CENTER);
  a.SetParentOrigin(Dali::ParentOrigin::CENTER);
}
