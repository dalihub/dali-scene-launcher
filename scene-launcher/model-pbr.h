...
public:
  ...
  {
    GET_SHADERS = SceneLauncher::CloneOptions::FIRST_USER_OPTION,
    GET_SKYBOX_TEXTURE = SceneLauncher::CloneOptions::FIRST_USER_OPTION << 1,
  };
  ...
  /**
   * @brief Adds the given texture to each texture set that any renderer on any actor might
