...
SceneLauncher::SceneLauncher(Dali::Application& app)
: mApp(app)
{
...
void SceneLauncher::OnInit(Application& app)
{
  ...
  tapDetector.DetectedSignal().Connect(this, &SceneLauncher::OnTap);
  mTapDetector = tapDetector;
...
void SceneLauncher::OnTap(Dali::Actor actor, const Dali::TapGesture& tap)
{
