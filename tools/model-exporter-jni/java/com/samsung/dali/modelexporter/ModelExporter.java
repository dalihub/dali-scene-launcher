...
public class ModelExporter {
   ...
   *        .dli files.
   * @param inputPath - path and name of the .dae file to process. Required.
   * @param outputPath - path (incl. name) to save the .dli and .bin files to.
   ...
   * @param inputPath - path (incl. name) of the .dae file to process. Required.
   * @param binaryOutputPath - path (incl. name) to save the .bin file to.
