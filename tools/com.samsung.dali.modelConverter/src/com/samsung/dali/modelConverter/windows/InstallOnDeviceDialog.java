...
public class InstallOnDeviceDialog extends Dialog implements ILogText {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    mPath.setText( GlobalData.Get().mInstallPackagePath );
    ...
    mCurrentProfile.setText(GlobalData.Get().mCurrentProfile);
    return area;
  }
  ...
  protected void okPressed() {
    ...
    try
    {
      ...
      if( mChkPackage.getSelection() ) {
        ...
        lpr.addCommand( GlobalData.Get().mTizenPath + "tizen" + extension  + " package -t tpk -s " + GlobalData.Get().mCurrentProfile
      ...
      if( mChkInstall.getSelection() ) {
        ...
        lpr.addCommand(GlobalData.Get().mSdbPath + "sdb" + " install " +
