	...
	protected Control createDialogArea(Composite parent) {
		...
		mbtnBrowse.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.open();
				GlobalData.Get().InstallPackagePath = dialog.getFilterPath();
			}
		});
		...
		mPath.setText( GlobalData.Get().InstallPackagePath );
		...
		mCurrentProfile.setText(GlobalData.Get().CurrentProfile);
		return area;
	}
