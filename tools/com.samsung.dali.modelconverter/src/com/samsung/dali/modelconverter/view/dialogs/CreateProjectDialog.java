...
public class CreateProjectDialog extends Dialog {
  ...
  public void setBtnBrowse(Button mBtnBrowse) {
    this.mBtnBrowse = mBtnBrowse;
  }

  public Text getTxtProjectName() {
    return mTxtProjectName;
  }

  public void setTxtProjectName(Text mTxtProjectName) {
    this.mTxtProjectName = mTxtProjectName;
  }

  public Text getTxtProjectID() {
    return mTxtProjectID;
  }

  public void setTxtProjectID(Text mTxtProjectID) {
    this.mTxtProjectID = mTxtProjectID;
  }

  public Text getTxtProjectPath() {
    return mTxtProjectPath;
  }

  public void setTxtProjectPath(Text mTxtProjectPath) {
    this.mTxtProjectPath = mTxtProjectPath;
  }
