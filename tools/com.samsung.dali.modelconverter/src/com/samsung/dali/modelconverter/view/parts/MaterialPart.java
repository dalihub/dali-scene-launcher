...
public class MaterialPart {
  ...
  public static final String sId = "com.samsung.dali.modelconverter.part.materials";
  ...
  public void populate(ResourceContentProvider<Material> provider, PropertyProviderSelectionChangedListener listener) {
    mTree.removeAll();
