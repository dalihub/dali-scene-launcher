...
public class MeshPart {
  ...
  public static final String sId = "com.samsung.dali.modelconverter.part.meshes";
  ...
  public void populate(ResourceContentProvider<Mesh> provider, PropertyProviderSelectionChangedListener listener) {
    mTree.removeAll();
