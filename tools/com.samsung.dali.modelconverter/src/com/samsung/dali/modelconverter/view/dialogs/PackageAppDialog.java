...
public class PackageAppDialog extends Dialog {
  ...
  protected Control createDialogArea(Composite parent) {
    ...
    fd_mLb2.top = new FormAttachment(mPath, 6);
  ...
  public void setConsole(StyledText mConsole) {
    this.mConsole = mConsole;
  }


  public Button getChkPackage() {
    return mChkPackage;
  }


  public void setChkPackage(Button mChkPackage) {
    this.mChkPackage = mChkPackage;
  }


  public Button getChkInstall() {
    return mChkInstall;
  }


  public void setChkInstall(Button mChkInstall) {
    this.mChkInstall = mChkInstall;
  }
