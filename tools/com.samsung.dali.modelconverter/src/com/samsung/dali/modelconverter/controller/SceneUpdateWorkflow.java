...
public class SceneUpdateWorkflow {
  ...
  private static void updateMaterials(Document doc, EPartService parts)
  {
    ResourceContentProvider<Material> provider = new ResourceContentProvider<Material>( doc.getMaterials() );
